// ----------------------------------------------------------------------
// <copyright file="SampleDocumentGeneratorUsingDatabinding.cs" author="Atul Verma">
...
namespace WordDocumentGenerator.Client
{
    ...
    /// <summary>
    /// Sample refreshable document generator for Test_Template - 1.docx template using data bound content controls
    /// </summary>
    public class SampleDocumentGeneratorUsingDatabinding : SampleRefreshableDocumentGenerator
    {
        #region Constructor

        /// <summary>
        /// Initializes a new instance of the <see cref="SampleDocumentGeneratorUsingDatabinding"/> class.
        /// </summary>
        /// <param name="generationInfo">The generation info.</param>
        public SampleDocumentGeneratorUsingDatabinding(DocumentGenerationInfo generationInfo)
            : base(generationInfo)
        {
        }
